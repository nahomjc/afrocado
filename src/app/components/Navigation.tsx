                    ...
                    <div className="p-6">
                      ...
                      <div className="relative mb-4">
                        ...
                        <input
                          ...
                          className="block w-full pl-12 pr-12 py-4 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-green-500/20 focus:border-green-500 text-base bg-white/80 backdrop-blur-sm transition-all duration-300 shadow-lg focus:shadow-xl text-black placeholder:text-gray-300 placeholder:font-medium"
                        />
                        <motion.button
                          onClick={clearSearch}
