                  ...
                  <div className="relative rounded-2xl overflow-hidden bg-gray-900 shadow-inner">
                    ...
                    >
                      <iframe
                        ...
                        src={`https://www.youtube.com/embed/${youtubeVideoId}?rel=0&modestbranding=1&showinfo=0&controls=1&iv_load_policy=3&cc_load_policy=0&fs=1&playsinline=1&mute=1&autoplay=1&enablejsapi=1`}
